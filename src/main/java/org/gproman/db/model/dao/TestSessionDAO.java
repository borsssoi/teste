...
public interface TestSessionDAO {
     ...
     */
    public void create(TestSession bean, Connection conn) throws SQLException;
     ...
     * @exception       SQLException if something is wrong.
     */
    public TestSession load(Integer key, Connection conn) throws SQLException;
     ...
     * @exception    SQLException if something is wrong.
     */
    public int update(TestSession bean, Connection conn) throws SQLException;
