 ...
 */
public interface EverestDriverDAO {
    /**
     ...
     */
    public void create(Driver bean, Connection conn) throws SQLException;
     ...
     * @exception       SQLException if something is wrong.
     */
    public Driver load(Integer key, Connection conn) throws SQLException;
     ...
     * @exception    SQLException if something is wrong.
     */
    public int update(Driver bean, Connection conn) throws SQLException;
